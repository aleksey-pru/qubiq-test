    ...
    return (
        <section className="px-4 pt-16">
            <div className="max-w-md mx-auto md:max-w-[1370px]">
                <h2 className="text-[36px] md:text-[48px] font-semibold text-[#303030] mb-3">
                    What is Backyard?
                </h2>
                ...
                <div className="md:hidden">
                    <div className="text-center">
                        <div className="transition-all duration-300 ease-in-out">
                            ...
                            <div className="flex items-center justify-left gap-4 mb-6 rounded-3xl bg-[#f4f6f7] p-2">
                            ...
                            <div className="mb-8 rounded-2xl bg-[#f4f6f7] p-2">
                                <h4 className="text-[24px] font-semibold text-[#303030] mb-4">
                                    {backyardSlides[currentSlide].heading}
                                </h4>
                                <p className="text-[16px] text-[rgba(38,38,38,0.55)] leading-relaxed max-w-sm mx-auto">
                        ...
                        <div className="flex justify-center gap-4 mb-6">
                            <button
                                onClick={() =>
                                    setCurrentSlide(
                                        (prev) =>
                                            (prev - 1 + backyardSlides.length) %
                                            backyardSlides.length
                                    )
                                }
                ...
                <div className="hidden md:flex md:items-center md:justify-between md:gap-12 lg:hidden">
                    <div className="flex-1">
                        <div className="flex items-center gap-4 mb-6 rounded-2xl bg-[#f4f6f7] p-3  max-w-md">
                        ...
                        <div className="rounded-2xl bg-[#f4f6f7] p-4 max-w-md">
                ...
                <div className="hidden lg:grid lg:grid-cols-3 lg:gap-18">
                    {backyardSlides.map((slide) => (
                        <div key={slide.id} className="text-center p-6">
                            <Image
                                src={slide.image}
                                alt={slide.title}
                                width={179}
                            ...
                            <div className="flex items-center gap-3 mb-4 bg-[#f4f6f7] rounded-2xl p-2">
                            ...
                            <div className="bg-[#f4f6f7] rounded-2xl p-2">
                                ...
                                <p className="text-[14px] text-[rgba(38,38,38,0.55)] leading-relaxed">
                                    {slide.description}
                                </p>
                            </div>
                        </div>
